				...
				<div class="col-md-10 col-sm-12">
					...
					<nav class="navbar ow-navigation">
						<div class="navbar-header">
							...
							<a title="Logo" href="#" class="navbar-brand"><img src="<?php echo base_url(); ?>assets/images/logo0.png" alt="logo"/><span>GARASI</span></a>
						</div>
						<div class="navbar-collapse collapse" id="navbar">
							<ul class="nav navbar-nav menubar">
								<!-- User -->
								
								<li class="active"><a title="Beranda" href="<?php echo base_url(); ?>welcome">Beranda</a></li>
								<!-- <li><a title="Services" href="<?php echo base_url(); ?>welcome/services">Services</a></li> -->
								<li><a title="Jadilah Mitra Kami" href="<?php echo base_url(); ?>welcome/eventgrid">Jadilah Mitra Kami</a></li>
								<!-- <li class="dropdown">
									<a aria-expanded="false" aria-haspopup="true" role="button" class="dropdown-toggle" title="Blog" href="#">Latest News</a>
									<i class="ddl-switch fa fa-angle-down"></i>
									<ul class="dropdown-menu">
										<li><a title="Blog" href="<?php echo base_url(); ?>welcome/blog">Blog</a></li>
										<li><a title="Blog Post" href="<?php echo base_url(); ?>welcome/blogpost">Blog Post</a></li>
									</ul>
								</li> -->
								<li><a title="Tentang Garasi" href="<?php echo base_url(); ?>welcome/about">Tentang Garasi</a></li>
								<li><a title="Hubungi Kami" href="<?php echo base_url(); ?>welcome/contactus">Hubungi Kami</a></li>
								<li><a title="Pesan" href="<?php echo base_url(); ?>welcome/upload">Pesan</a></li>
							</ul>
						</div>
					</nav><!-- Navigation /- -->
				</div>
