			...
			<div class="container">
				...
				<a href="<?php echo base_url(); ?>welcome" style="background-color: white" class="user" title="Logo">
							<img src="<?php echo base_url(); ?>assets/images/logo0.png" alt="logo" />
								...
								<div class="dropdown">
									<a aria-expanded="false" aria-haspopup="true" role="button" class="dropdown-toggle menu-search" title="Account" href="<?php echo base_url(); ?>welcome/login">
					...
					<nav class="navbar ow-navigation">
						...
						<div class="navbar-collapse collapse" id="navbar">
							<ul class="nav navbar-nav menubar">
								...
								<li><a title="Event" href="<?php echo base_url(); ?>welcome/eventgrid">Jadilah Mitra Kami</a></li>
								<li><a title="About Us" href="<?php echo base_url(); ?>welcome/about">Tentang Garasi</a></li>
